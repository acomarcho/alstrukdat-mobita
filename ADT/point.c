...
void Putar (POINT *P, float Sudut) {
  ...
  float DerajatSudut = -1 * (Sudut * PI/180);
  float AbsisBaru = Absis(*P) * cos(DerajatSudut) - Ordinat(*P) * sin(DerajatSudut);
  float OrdinatBaru = Ordinat(*P) * cos(DerajatSudut) + Absis(*P) * sin(-1 * (Sudut * PI/180));
  // ALGORITMA
  Absis(*P) = AbsisBaru;
