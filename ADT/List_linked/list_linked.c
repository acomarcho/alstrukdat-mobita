...
void displayToDo(List l){
  if (isEmptyLL(l)) printf("Tidak ada pesanan pada To Do List.\n");
  else{
    List P = LL_FIRST(l);
    int i = 1;
...
void displayInProgress(List l){
  if (isEmptyLL(l)) printf("Tidak ada pesanan yang sedang diantarkan.\n");
  else{
    List P = LL_FIRST(l);
    int i = 1;
